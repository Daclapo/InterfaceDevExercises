...
<body>
    <div class="container">
        ...
        <form id="ajax-form">
            ...
            <label>
                Nombre:
                <input type="text" id="name" placeholder="Introduzca su nombre">
            </label>
            <br>
            <label>
                Edad:
                <input type="number" id="age" placeholder="Introduzca su edad">
            </label>
            <br>
        ...
        <br>
        <h2>Previsualización de la Solicitud:</h2>
    ...
    <script>
        function sendAjaxRequest() {
            ...
            let params = `name=${encodeURIComponent(name)}&age=${encodeURIComponent(age)}`;
...
Cuando el servidor responde con XML, se puede parsear utilizando responseXML o un DOMParser para manipularlo como un documento XML. <br><br>
    </span>
</body>
</html>